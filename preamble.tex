...
\ifIndonesian
    \def\noteboxTitle{\boxicon{blue!70!black}{i}~Catatan}
    \def\warningboxTitle{\boxicon{red!75!black}{!}~Peringatan}
    \def\tipboxTitle{\boxicon{green!60!black}{+}~Tips}
    \def\exampleboxPrefix{\boxicon{orange!80!black}{C}~Contoh: }
    \def\exerciseboxPrefix{Latihan }
    \def\challengeboxTitle{\boxicon{teal!75!black}{*}~Tantangan}
\else
    \def\noteboxTitle{\boxicon{blue!70!black}{i}~Note}
    \def\warningboxTitle{\boxicon{red!75!black}{!}~Warning}
    \def\tipboxTitle{\boxicon{green!60!black}{+}~Tip}
    \def\exampleboxPrefix{\boxicon{orange!80!black}{E}~Example: }
    \def\exerciseboxPrefix{Exercise }
    \def\challengeboxTitle{\boxicon{teal!75!black}{*}~Challenge}
\fi
