...
\newtcolorbox{notebox}{
    ...
    title=\noteboxTitle,
    fonttitle=\bfseries,
    top=3pt, bottom=3pt, toptitle=2pt, bottomtitle=2pt
}
...
\RedeclareSectionCommand[beforeskip=1.2cm, afterskip=0.4cm]{chapter}
\RedeclareSectionCommand[
    beforeskip=-1.8ex plus -1ex minus -.2ex,
    afterskip=0.5ex plus .2ex
]{section}
\RedeclareSectionCommand[
    beforeskip=-1.4ex plus -1ex minus -.2ex,
...
\setlist{topsep=3pt, parsep=0pt, itemsep=2pt, partopsep=2pt}
