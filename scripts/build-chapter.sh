...
# Example: ./scripts/build-chapter.sh en week01-introduction
#          ./scripts/build-chapter.sh id week02-hardware-and-basic-commands
...
if [ -z "$LANG" ] || [ -z "$CHAPTER" ]; then
    ...
    echo "Example: $0 en week01-introduction"
    exit 1
fi
