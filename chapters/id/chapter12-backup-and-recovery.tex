...
\chapterhero{gray}{Rancang cadangan data yang andal, otomasi jadwal backup, dan latihan pemulihan agar kehilangan data tidak berubah menjadi bencana.}{\faSync\quad rsync}{\faClock\quad cron}{\faLifeRing\quad recovery}

Kegagalan \term{hardisk}, file yang tidak sengaja dihapus, serangan ransomware, mati
listrik di saat yang salah: semua ini adalah kejadian nyata yang dialami oleh
administrator sistem di seluruh dunia. Bukan soal \textit{jika} terjadi, tapi
\textit{kapan}. Backup adalah jaring pengaman yang memastikan kejadian buruk
tidak berubah menjadi bencana yang tidak bisa dipulihkan.
...
%% ========================================================================
\section{Perintah tar dan dd untuk Arsip}
