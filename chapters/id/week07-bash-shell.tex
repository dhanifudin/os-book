...
\dir{~/lab-os/week07-bash/}.
Buat direktori ini sebelum memulai:
\begin{lstlisting}[language=bash]
mkdir -p ~/lab-os/week07-bash
...
\subsection*{Praktikum 7.1: Modifikasi Prompt dan Konfigurasi Shell}

Tujuan praktikum ini adalah memahami peran file konfigurasi Bash dan
...
cp ~/.bashrc ~/.bashrc.bak-week07
echo "Backup selesai: ~/.bashrc.bak-week07"
\end{lstlisting}
...
# === Konfigurasi Week07 Bash Shell ===
# Prompt: user@host:dir [waktu]$
PS1='\u@\h:\w [\t]\$ '
export EDITOR=nano
export VISUAL=nano
# === Akhir Konfigurasi Week07 ===
...
\subsection*{Praktikum 7.2: Kelola Variabel Lingkungan}

Tujuan praktikum ini adalah memahami perbedaan variabel lokal dan
...
\begin{challengebox}
Tambahkan direktori \dir{~/lab-os/week07-bash/bin} ke \var{PATH} secara
...
\subsection*{Praktikum 7.3: Buat Alias dan Fungsi Produktivitas}

Tujuan praktikum ini adalah membuat alias dan fungsi yang berguna untuk
...
alias ..='cd ..'
alias ...='cd ../..'
alias week07='cd ~/lab-os/week07-bash'
# === Akhir Alias Week07 ===
...
mkdir -p ~/lab-os/week07-bash/backup
echo "PORT=8080\nHOST=localhost" > ~/lab-os/week07-bash/app.conf

backup_conf ~/lab-os/week07-bash/app.conf
backup_conf ~/lab-os/week07-bash/app.conf
...
\subsection*{Praktikum 7.4: Gunakan Ekspansi dan History}

Tujuan praktikum ini adalah menguasai wildcard, brace expansion, dan
...
\texttt{minggu-\{01..05\}} di dalam \dir{~/lab-os/week07-bash/proyek}.
...
\subsection*{Praktikum 7.5: Pahami Perbedaan Quoting}

Tujuan praktikum ini adalah memahami kapan menggunakan single quote,
...
FILE_LAMA="$HOME/lab-os/week07-bash/laporan bulan ini.txt"
FILE_BARU="$HOME/lab-os/week07-bash/arsip/laporan-baru.txt"

mkdir -p ~/lab-os/week07-bash/arsip
cp "$FILE_LAMA" "$FILE_BARU"
ls -lah ~/lab-os/week07-bash/arsip/
\end{lstlisting}
...
\label{sec:tugas-praktikum-bash-shell}

\textbf{Instruksi Umum}: kerjakan seluruh tugas di direktori
\dir{~/lab-os/week07-bash/}. Simpan semua skrip di subdirektori
\dir{bin/} dan semua hasil ke subdirektori \dir{output/}.

\begin{exercisebox}[7.1 Toolkit Bash Pribadi]
...
direktori \dir{~/lab-os/week07-bash/bin} ke \var{PATH}. Buat skrip
...
\begin{exercisebox}[7.2 Audit File dengan Wildcard dan Redirection]
...
\dir{~/lab-os/week07-bash/logs} menggunakan brace expansion dengan nama
...
\begin{exercisebox}[7.3 Sistem Health Check Harian]
