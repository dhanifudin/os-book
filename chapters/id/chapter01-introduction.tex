...
Ada satu program yang sudah aktif sebelum kamu bisa login, sebelum browser bisa dibuka,
bahkan sebelum sistem meminta kata sandi. Program itu yang mengatur seluruh perangkat
keras, membagi waktu prosesor di antara banyak tugas, dan memastikan setiap aplikasi
mendapat ruang memori yang aman. Program itu adalah \textbf{sistem operasi}. Tanpa
sistem operasi, setiap program harus menulis sendiri kode untuk berbicara dengan kartu
jaringan, layar, dan disk: pendekatan yang tidak efisien dan hampir mustahil diterapkan
secara luas~\cite{silberschatz2018operating, ward2021how}.
...
\begin{table}[tbp]
    ...
    \begin{tblr}{
        ...
        1969: Lahirnya Unix &
            ...
            portabel, dan ditulis dalam bahasa C dengan filosofi \textit{do one thing well}~\cite{ritchie1974unix} \\
        1980-an: Era PC &
        ...
        1991: Linux &
            ...
            lunak bebas dan terbuka; kompatibel dengan Unix~\cite{torvalds1991linux} \\
        1993: Windows NT &
...
pendekatan memiliki tempatnya masing-masing~\cite{tanenbaum2014modern}. Linux mendominasi
server dengan desain monolitik-modular, sementara QNX dengan mikrokernel mendominasi
sistem otomotif.
...
\begin{enumerate}
    \item \textbf{Gratis dan terbuka.} Kode sumber Linux tersedia untuk siapa saja~\cite{kernelorg2024}.
    ...
    menggunakan Linux sebagai sistem operasi utama mereka~\cite{linuxfoundation2024}.
...
# Uji koneksi internet dengan mengirim 4 paket ke DNS Google
ping -c 4 8.8.8.8
# Tampilkan penggunaan disk dalam format mudah dibaca
df -h
# Tampilkan penggunaan memori dan swap
free -h
# Tampilkan daftar proses secara interaktif
htop
\end{lstlisting}
