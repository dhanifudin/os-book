...
\subsection{\term{Kernel space} dan \term{User space}}
...
\begin{table}[htbp]
    ...
    \begin{tblr}{
        ...
        Deskripsi &
            Semua layanan berjalan di \term{kernel space} dalam satu binary besar &
...
\begin{figure}[H]
    ...
    \caption{Perbandingan arsitektur kernel: area merah menunjukkan layanan di
    \term{kernel space}, area biru di \term{user space}}
