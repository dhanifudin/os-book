...
\chapterhero{blue}{Pahami fondasi sistem operasi, pilihan distribusi Linux, proses instalasi, dan verifikasi awal agar sistem siap dipakai sebagai lingkungan belajar.}{konsep dasar}{instalasi}{verifikasi}
...
Praktek pada bab ini menggunakan \textbf{mesin virtual} (virtual machine). Mesin
...
Saat memilih \textit{Use an entire disk} pada Praktek 1.2, Ubuntu membuat tata letak
...
\subsection*{Praktek 1.7 Memeriksa Partisi dan Sistem Berkas}
