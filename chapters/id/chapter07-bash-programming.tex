...
\chapterhero{purple}{Ubah rangkaian perintah manual menjadi skrip yang rapi, dapat dipakai ulang, dan lebih aman melalui fungsi, validasi, serta debugging Bash.}{skrip}{fungsi}{debugging}
