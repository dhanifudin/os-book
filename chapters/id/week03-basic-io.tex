...
\begin{notebox}
Seluruh praktikum pada bab ini dijalankan pada direktori \dir{~/lab-os/week03-io/}.
Buat direktori ini sebelum memulai praktikum pertama:
\begin{lstlisting}[language=bash]
mkdir -p ~/lab-os/week03-io
cd ~/lab-os/week03-io
\end{lstlisting}
\end{notebox}
...
\subsection*{Praktikum 3.1: Amati File Descriptor Proses Aktif}

Tujuan praktikum ini adalah melihat file descriptor yang dimiliki proses shell dan memahami kemana masing-masing mengarah.
...
\subsection*{Praktikum 3.2: Simpan Output Perintah ke Berkas}

Tujuan praktikum ini adalah berlatih menggunakan operator \texttt{>}, \texttt{>>}, \texttt{2>}, dan \texttt{2>\&1} dalam situasi nyata.
...
\subsection*{Praktikum 3.3: Bangun Pipeline Bertingkat}

Tujuan praktikum ini adalah membangun pipeline langkah demi langkah untuk menganalisis data sistem.
...
\subsection*{Praktikum 3.4: Output ke Berkas dan Terminal Sekaligus}

Tujuan praktikum ini adalah menggunakan \cmd{tee} dalam pipeline dan membuat berkas dengan here-document.
...
\begin{exercisebox}[3.1 Pengalihan dan Pemisahan I/O]
...
\begin{exercisebox}[3.2 Pipeline Analisis Sistem]
...
\begin{exercisebox}[3.3 Membuat Log Sistem Otomatis]
