...
\chapterhero{violet}{Pelajari bagaimana aliran data bekerja di shell melalui file descriptor, redirection, pipeline, dan teknik pemrosesan input-output yang efisien.}{\faIcon{exchange-alt}\quad stdin/stdout}{\faProjectDiagram\quad pipeline}{\faIcon{sign-in-alt}\quad redirection}
...
Tiga file descriptor pertama sudah tersedia untuk setiap proses sejak dijalankan. FD~0
adalah \textit{stdin} (standard input): saluran untuk membaca input, secara default
terhubung ke keyboard. FD~1 adalah \textit{stdout} (standard output): saluran untuk
output normal, secara default mengarah ke layar terminal. Yang ketiga berbeda sedikit:
FD~2 atau \textit{stderr} khusus untuk pesan kesalahan dan bisa dialihkan secara
terpisah dari stdout, bahkan ketika keduanya sama-sama mengarah ke layar.
...
%% ------------------------------------------------------------------------
\section{Perintah tee dan Teknik Lanjutan}
