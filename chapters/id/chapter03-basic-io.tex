...
\chapterhero{violet}{Pelajari bagaimana aliran data bekerja di shell melalui file descriptor, redirection, pipeline, dan teknik pemrosesan input-output yang efisien.}{stdin/stdout}{pipeline}{redirect}
