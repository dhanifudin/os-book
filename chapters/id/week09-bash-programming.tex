...
dan melakukan debugging. Konsep dibandingkan dengan Java agar pembaca yang
...
bawah yang menampilkan: jumlah peserta per grade (A, B, C, D, E)
...
\textbf{Konteks:} instruktur mencatat kehadiran peserta dari command line.

\textbf{Instruksi:}
\begin{enumerate}
  \item Buat script \texttt{absensi.sh} yang:
  \begin{itemize}
    \item Menerima argumen nama peserta dan status
