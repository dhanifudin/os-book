...
\begin{enumerate}
    \item menjelaskan fungsi direktori-direktori utama dalam hierarki sistem file Linux (FHS);
...
\begin{notebox}
Seluruh praktikum pada bab ini dijalankan pada direktori \dir{~/lab-os/week05-files/}.
Buat direktori ini sebelum memulai:
\begin{lstlisting}[language=bash]
mkdir -p ~/lab-os/week05-files
cd ~/lab-os/week05-files
\end{lstlisting}
\end{notebox}
...
\subsection*{Praktikum 5.1 Jelajahi Direktori-Direktori Utama}

Tujuan praktikum ini adalah membiasakan mata dengan isi direktori standar Linux dan
...
\subsection*{Praktikum 5.2 Identifikasi Berbagai Jenis Berkas}

Tujuan praktikum ini adalah membedakan jenis berkas berdasarkan output \cmd{ls -l} dan
...
\begin{challengebox}
Buat sebuah tautan simbolis bernama \file{home-link} di direktori \dir{~/lab-os/week05-files/}
...
\subsection*{Praktikum 5.3 Bandingkan Hard Link dan Symbolic Link}

Tujuan praktikum ini adalah memahami perbedaan hard link dan symbolic link melalui inode,
...
\subsection*{Praktikum 5.4 Cari Berkas dengan Kriteria Tertentu}

Tujuan praktikum ini adalah menggunakan \cmd{find} dengan berbagai kriteria untuk menemukan
...
find /var/log -type f -name "*.log" -size +1M 2>/dev/null \
    > ~/lab-os/week05-files/log-besar.txt
cat ~/lab-os/week05-files/log-besar.txt
\end{lstlisting}
...
di direktori \dir{~/lab-os/week05-files/}. Pastikan pesan error permission diabaikan
...
\subsection*{Praktikum 5.5 Buat dan Ekstrak Arsip}

Tujuan praktikum ini adalah membuat arsip terkompresi, memeriksa isinya, dan mengekstraknya
...
\begin{challengebox}
Arsipkan seluruh direktori \dir{~/lab-os/week05-files/} menjadi sebuah berkas bernama
\file{week05-backup.tar.gz} yang disimpan di \dir{~/lab-os/}. Setelah selesai, gunakan
...
\begin{exercisebox}[5.1 Pemetaan Sistem File]
...
\begin{exercisebox}[5.2 Hard Link dan Symbolic Link]
Buat satu berkas \file{sumber.txt} di \dir{~/lab-os/week05-tugas/}. Setelah itu:
\begin{enumerate}
...
\begin{exercisebox}[5.3 Pencarian dan Pengarsipan]
...
\begin{enumerate}
    ...
    \item Arsipkan seluruh direktori \dir{~/lab-os/week05-tugas/} menjadi
    \file{week05-tugas.tar.gz}.
