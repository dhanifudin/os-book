...
\chapterhero{teal}{Kenali cara Linux mendeteksi perangkat keras, memuat driver, dan menyediakan perintah terminal dasar untuk mulai bekerja dengan percaya diri.}{hardware}{driver}{terminal}
...
Tujuan praktek ini adalah membaca spesifikasi prosesor, memori, dan perangkat PCI dari mesin virtual.
