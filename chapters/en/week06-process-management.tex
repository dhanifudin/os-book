...
\subsection*{Lab 6.1 --- Viewing Processes and Threads}
...
\subsection*{Lab 6.2 --- Observing the Process Lifecycle}
...
\subsection*{Lab 6.3 --- Adjusting Process Priority}
...
\subsection*{Lab 6.4 --- Sending Signals to Processes}
...
\subsection*{Lab 6.5 --- Foreground and Background Job Management}
...
\subsection*{Lab 6.6 --- Process Monitoring}
...
\begin{itemize}
  \item \texttt{man ps} --- complete documentation for ps and all its options
  \item \texttt{man top} --- top documentation including keyboard shortcuts
  \item \texttt{man 7 signal} --- technical reference for all Linux signals
  \item \texttt{man nice}, \texttt{man renice} --- process priority adjustment
  \item \texttt{man kill}, \texttt{man pkill}, \texttt{man pgrep} --- signal management
\end{itemize}
