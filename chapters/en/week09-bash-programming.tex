...
mkdir -p ~/lab-os/week09/{scripts,logs,data}
cd ~/lab-os/week09/scripts
\end{lstlisting}
...
\begin{exercisebox}[Exercise 9.1]
...
nano ~/lab-os/week09/scripts/system-info.sh
\end{lstlisting}
...
chmod +x ~/lab-os/week09/scripts/system-info.sh
./system-info.sh
...
\begin{exercisebox}[Exercise 9.2]
...
# loop over files
for FILE in ~/lab-os/week09/scripts/*.sh; do
...
nano ~/lab-os/week09/scripts/batch-grading.sh
\end{lstlisting}
...
chmod +x ~/lab-os/week09/scripts/batch-grading.sh
./batch-grading.sh
\end{lstlisting}
...
nano ~/lab-os/week09/scripts/system-menu.sh
\end{lstlisting}
...
chmod +x ~/lab-os/week09/scripts/system-menu.sh
./system-menu.sh
\end{lstlisting}
\end{enumerate}

\begin{exercisebox}[Exercise 9.3]
...
nano ~/lab-os/week09/scripts/lib-validation.sh
\end{lstlisting}
...
nano ~/lab-os/week09/scripts/use-library.sh
\end{lstlisting}
...
source ~/lab-os/week09/scripts/lib-validation.sh
...
chmod +x ~/lab-os/week09/scripts/use-library.sh
...
\begin{exercisebox}[Exercise 9.4]
...
nano ~/lab-os/week09/scripts/backup-data.sh
\end{lstlisting}
...
chmod +x ~/lab-os/week09/scripts/backup-data.sh
cd ~/lab-os/week09/scripts

# Without options
./backup-data.sh ~/lab-os/week09/data ~/lab-os/week09/logs

# With verbose and compression + logging to file
./backup-data.sh -v -c -l ../logs/backup.log \
  ~/lab-os/week09/data ~/lab-os/week09/logs
...
nano ~/lab-os/week09/scripts/debug-practice.sh
\end{lstlisting}
...
chmod +x ~/lab-os/week09/scripts/debug-practice.sh
...
\begin{exercisebox}[Exercise 9.5]
...
\begin{warningbox}
Do the assignments in \texttt{\$HOME/lab-os/week09/}. Put scripts in
...
%%---------------------------------------------------------------------
\section{References}
\label{sec:references-bash-prog}
...
\begin{enumerate}
  ...
  \item Arnold Robbins and Nelson H.F.\ Beebe, \textit{Classic Shell Scripting}. O'Reilly.
  \item Richard Blum and Christine Bresnahan, \textit{Linux Command Line and Shell Scripting Bible}, 4th Edition.
  \item ShellCheck, a static analysis tool for Bash scripts: \url{https://www.shellcheck.net}
\end{enumerate}
